...
from models.multitask_convnext import MultiTaskConvNeXt, MultiTaskLoss
...
def main():
    ...
    train_df, val_df = split_train_val(df, CONFIG.VAL_RATIO, CONFIG.RANDOM_STATE)
    ...
    save_predictions_csv(
        pred['file_names'], pred['y_shape'], pred['y_coat'],
        pred['pred_shape'], pred['pred_coat'],
        pred['prob_shape'], pred['prob_coat'],
        os.path.join(output_dir, 'reports/val_predictions.csv')
    )
